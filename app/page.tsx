...
export default function HomePage() {
  // Data dummy bisa diganti dengan fetch dari API nanti
  const dummyStatus = { label: 'Sistem OSCAR', status: 'online' as const, probability: 87.5 };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Pantau deteksi dini OSCC secara real-time</p>
        </div>
